...
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/project_hub/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/project_hub/archive/master.zip", tmp)
    file += "master"
